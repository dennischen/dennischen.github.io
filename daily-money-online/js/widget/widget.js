...
define(["require", "exports", 'react', 'react-dom', 'jquery', '../util/event-queue'], function (require, exports, React, ReactDOM, jq, EventQueue) {
    "use strict";
    exports.QUEUE_EVENTS = {
        ON_RESIZE: 'onResize'
    };
    var queueName = 'bwWidgetQueue';
    var queue;
    function sendResize() {
        queue.send({ name: exports.QUEUE_EVENTS.ON_RESIZE, data: {} });
    }
    exports.sendResize = sendResize;
    if (window && !window[queueName]) {
        window[queueName] = queue = new EventQueue.SimpleQueue();
        ...
        List.prototype.getRenderChildren = function () {
            ...
            if (props.model) {
                ...
                var childrenNodes = props.model.map(function (each, idx) {
                    ...
                    return React.createElement("li", {key: key, className: selected ? 'bw-selected' : undefined, onClick: onItemClick, onDoubleClick: onItemDoubleClick, onContentMenu: onItemContextMenu}, templateNode);
                });
                ...
                var childrenNodes = React.Children.map(props.children, function (child, idx) {
                    ...
                    return React.createElement("li", {className: selected ? 'bw-selected' : undefined, onClick: onItemClick, onDoubleClick: onItemDoubleClick, onContextMenu: onItemContextMenu}, child);
                });
                return React.createElement("ul", null, childrenNodes);
            }
            else {
